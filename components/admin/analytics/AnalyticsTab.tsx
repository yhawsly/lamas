    ...
    return (
        <div className="w-full space-y-8 animate-pulse">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {[1, 2, 3, 4].map(i => (
                    <div key={i} className="rounded-3xl p-6 bg-slate-100 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800/80 space-y-3">
...
export default function AnalyticsTab() {
    ...
    return (
        <div className="w-full space-y-8 animate-in fade-in duration-500 font-sans">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {/* Average Compliance */}
                <div className="group relative rounded-3xl p-6 bg-white dark:bg-slate-900 border border-slate-200/90 dark:border-slate-800 shadow-sm hover:shadow-md transition-all">
                    ...
                    <div className="mt-4">
                        ...
                        <p className="text-xs font-bold text-slate-400 uppercase tracking-wider mt-1">Average Compliance</p>
                    </div>
                    {/* Progress Bar */}
                ...
                <div className="group relative rounded-3xl p-6 bg-white dark:bg-slate-900 border border-slate-200/90 dark:border-slate-800 shadow-sm hover:shadow-md transition-all">
                    <div className="flex items-center justify-between">
                        ...
                        <span className="text-xs font-bold text-slate-400">Active Cycle</span>
                    </div>
                    <div className="mt-4">
                        <div className="text-3xl font-black text-slate-900 dark:text-white tracking-tight">
                            {summary.totalLecturers}
                        </div>
                        <p className="text-xs font-bold text-slate-400 uppercase tracking-wider mt-1">Faculty Tracked</p>
                    </div>
                    <p className="text-[11px] font-semibold text-slate-400 mt-3 flex items-center gap-1">
                        <span>Across {departments.length || 1} academic departments</span>
                    </p>
                </div>
                ...
                <div className="group relative rounded-3xl p-6 bg-white dark:bg-slate-900 border border-slate-200/90 dark:border-slate-800 shadow-sm hover:shadow-md transition-all">
                    <div className="flex items-center justify-between">
                        ...
                        <span className="px-2.5 py-0.5 rounded-md text-[10px] font-bold bg-emerald-50 dark:bg-emerald-950 text-emerald-600 dark:text-emerald-300">
                            Verified
                        </span>
                    </div>
                    <div className="mt-4">
                        ...
                        <p className="text-xs font-bold text-slate-400 uppercase tracking-wider mt-1">Processed Submissions</p>
                    </div>
                    <p className="text-[11px] font-semibold text-slate-400 mt-3">
                        Syllabi, topics & teaching logs
                    </p>
                </div>
                ...
                <div 
                    ...
                    className={`group relative rounded-3xl p-6 border shadow-sm hover:shadow-md transition-all cursor-pointer ${
                ...
                >
                    <div className="flex items-center justify-between">
                        ...
                        <span className={`px-2.5 py-1 rounded-full text-[10px] font-black tracking-wider uppercase ${
                            summary.atRiskCount > 0 ? "bg-rose-500 text-white" : "bg-slate-100 dark:bg-slate-800 text-slate-400"
                        }`}>
                            {summary.atRiskCount > 0 ? `${summary.atRiskCount} Action Needed` : "Clear"}
                        </span>
                    </div>
                    <div className="mt-4">
                        <div className="text-3xl font-black text-slate-900 dark:text-white tracking-tight">
                        ...
                        <p className="text-xs font-bold text-slate-400 uppercase tracking-wider mt-1">At-Risk Interventions</p>
                    </div>
                    <p className="text-[11px] font-bold text-rose-600 dark:text-rose-400 mt-3 flex items-center gap-1">
                        <span>Click to filter at-risk faculty</span>
