                                    ...
                                    >
                                        ...
                                        <div className="flex items-center gap-2 pt-2 border-t" style={{ borderColor: "var(--bg-border)" }}>
                                            <button
                                                ...
                                                className="flex-1 py-2 px-3 rounded-xl text-xs font-bold text-white bg-indigo-600 hover:bg-indigo-700 transition-colors flex items-center justify-center gap-1.5 shadow-sm active:scale-95"
                                            >
                                            ...
                                            <a
                                                ...
                                                className="py-2 px-3 rounded-xl text-xs font-bold border transition-colors flex items-center justify-center gap-1.5 hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-700 dark:text-slate-300"
