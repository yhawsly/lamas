...
export default function ConductObservationPage() {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            if (res.ok) router.push("/deo/observations");
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end pb-6 border-b" style={{ borderColor: "var(--bg-border)" }}>
                <div>
                    ...
                    <div className="text-sm space-y-1" style={{ color: "var(--text-secondary)" }}>
                        ...
                        <p><strong>Session Date:</strong> {new Date(data.sessionDate).toLocaleDateString("en-GB", { day: "numeric", month: "long", year: "numeric" })}</p>
                    </div>
                </div>
